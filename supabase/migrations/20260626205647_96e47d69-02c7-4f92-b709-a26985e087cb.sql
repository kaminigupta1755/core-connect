-- =====================================================
-- SECURITY FIX: Part 3 - More sensitive tables (replay of failed block 103)
-- =====================================================
...
DROP POLICY IF EXISTS "developers_select_own_or_managers" ON public.developers;
...
DROP POLICY IF EXISTS "franchise_accounts_select_own_or_admin" ON public.franchise_accounts;
...
DROP POLICY IF EXISTS "reseller_accounts_select_own_or_managers" ON public.reseller_accounts;
...
DROP POLICY IF EXISTS "influencer_accounts_select_own_or_admin" ON public.influencer_accounts;
...
DROP POLICY IF EXISTS "prime_user_profiles_select_own_or_support" ON public.prime_user_profiles;
...
DROP POLICY IF EXISTS "developer_registrations_select_own_or_hr" ON public.developer_registrations;
...
DROP POLICY IF EXISTS "kyc_documents_select_own_or_legal" ON public.kyc_documents;
...
-- 8. demo_login_credentials - SKIPPED (table not present in schema)
